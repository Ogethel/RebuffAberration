...
namespace ALS.Aberration
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapMenu = "Quiz/Load Bootstrap Scene On Play";
        private const string k_DontLoadBootstrapMenu = "Quiz/Don't Load Bootstrap Scene On Play";
